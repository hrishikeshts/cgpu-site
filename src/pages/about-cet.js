    ...
    return (
        ...
        <div className="overall-styling">
                    ...
                    <div className='col-6 my-4'>
                        ...
                        <div className='abt-desc'>
                           ...
                           Varma,College of Engineering,Trivandrum is the first engineering collge in Kerala.
                            <br />
                            <br />
                            Ranked at <span className="textHighlights">85</span> among <span className="textHighlights">engineering colleges in India by NIRF</span> in 2020,CET always rankis within top 100 engineering colleges of India every year.
                            With such an eminence in the academic and curricular activities,the College is the most
                            sought after engineering college by the applicants of engineering degree programmes in the state.
                            <br />
                            <br />
                            <Link to="/" className="learnLink">Learn More</Link>
                        </div>
                    </div>
              ...
              <div className='row abt-sub-1'>
                  ...
                  <div className='abt-desc'>
                      CET alumni ae distinguished forerunners in every possible technological field across the world.
                      The CET Alumni association,the CETAA is very much active in the college bringing together the CET-ians
                      of yesteryears and present cream.
                      <br />
                  ...
                  <div className='alumnicontent  col-6 my-4'>
                    ...
                    <ul>
                        {alumni.map(x=> <li className="abt-desc" style={{fontSize:'18px'}}>{x}</li>)}
                    </ul>
                  </div>
              </div>
              </div>  
